<%@ page import="com.grails.Company; com.administrate.User" %>
...
<div align="center">
    ...
    <g:form name="signUpForm" url="[controller:'signUp', action:'saveSignUp']">
        ...
        <h3 style="margin-top: 10px">Give Personal Details</h3>
        ...
        <h3 style="margin-top: 10px">Insert Login Details</h3>
        ...
        <h3 style="margin-top: 10px">Insert Company Details</h3>
